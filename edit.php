<?php
	...
	$query = "UPDATE final.items SET item_name='$name', pic_link='$link', price = '$price', category='$category',inventory='$inv' WHERE item_id='$id'";
    ...
    $query2 = "SELECT item_id,item_name,pic_link,price,category,inventory FROM final.items";
